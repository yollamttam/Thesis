...
The outline of this paper is as follows. In \S\ref{sec:Bubblemethod} we describe the mock 21 cm data sets used in our investigations.
...
The power spectrum of the thermal noise is given by (\citealt{McQuinn:2006}, \citealt{Furlanetto:2006}):
\begin{equation}
P_{\text{N}}(k,\mu) =
