...
\firstcomittee[Assistant Professor, Physics and Astronomy]{James Aguirre}
\secondcomittee[Assistant Professor, Physics and Astronomy]{Cullen Blake}
\thirdcomittee[Professor, Physics and Astronomy]{Elliot Lipeles}
\fourthcomittee[Professor, Physics and Astronomy]{Masao Sako}
%\fifthcomittee[Professor, Physics and Astronomy]{Masao Sako}
...
\include{neutral_islands/neutral_islands}
\include{preliminary_neutral_islands/preliminary_neutral_islands}
\include{igm_temperature/igm_temperature}
\include{bubble_finding/bubble_finding}
